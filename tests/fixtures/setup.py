...
def _mint(acct, wrapped_coins, wrapped_amounts, underlying_coins, underlying_amounts, is_forked):
...
@pytest.fixture(scope="module")
def mint_bob(
    bob, underlying_coins, wrapped_coins, initial_amounts, initial_amounts_underlying, is_forked
):
    _mint(
        bob, wrapped_coins, initial_amounts, underlying_coins, initial_amounts_underlying, is_forked
    )
...
@pytest.fixture(scope="module")
def mint_alice(
    alice, underlying_coins, wrapped_coins, initial_amounts, initial_amounts_underlying, is_forked
):
    _mint(
        alice,
        wrapped_coins,
